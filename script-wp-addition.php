...
<?php
// Simulation exercice avec valeurs fictives
$premiereValeur = 16469;
$deuxiemeValeur = 1735;
// Résultat multiplication valeurs fictives
$result = $premiereValeur + $deuxiemeValeur;

// traitement fichier contenant le code
$file = $_FILES['codefile']['tmp_name'];

// Éxécution commande python avec fichier et valeur prédéfinie
$output = shell_exec('python3 '.$file.' '.$premiereValeur.' '.$deuxiemeValeur);

// Récupération numéro exercice
$num_exo = $_POST['num_exo'];

// Database Credential -> Prévoir de sortir ses informations dans un fichier secret
